#!/bin/bash
#SBATCH --job-name=abl1-dep-margin
...
# Submit with:
#   sbatch /home/sarthak.malla/dllm-selection-ensemble/examples/path_selection/ablation/1_dependecy_with_non_lookahead_samplers/run_min_top2_margin.slurm.sh

export ABLATION_SELECTOR=min_top2_margin
