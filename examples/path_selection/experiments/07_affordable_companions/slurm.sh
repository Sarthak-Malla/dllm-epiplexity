...
# Submit manually: sbatch /home/sarthak.malla/dllm-selection-ensemble/examples/path_selection/experiments/07_affordable_companions/slurm.sh
...
# Preserve reference seeds, budget, conflict, anchors, and cheap selection.
run_training_free benchmark --arm affordable_companions
