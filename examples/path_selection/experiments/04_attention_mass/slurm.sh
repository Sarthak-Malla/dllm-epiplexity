...
# Submit manually: sbatch /home/sarthak.malla/dllm-selection-ensemble/examples/path_selection/experiments/04_attention_mass/slurm.sh
...
# Reuse matching precedence probes; evaluate the representation separately.
run_training_free diagnose --experiment attention_mass
run_training_free benchmark --arm attention_mass
