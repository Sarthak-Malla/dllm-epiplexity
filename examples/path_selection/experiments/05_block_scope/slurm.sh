...
# Submit manually: sbatch /home/sarthak.malla/dllm-selection-ensemble/examples/path_selection/experiments/05_block_scope/slurm.sh
...
# Matching thresholds at block64 and block256, always confidence-only.
# %1 permits one array task at a time: two GPUs in total for this array.
case "${SLURM_ARRAY_TASK_ID:-}" in
    0) arm=threshold_0.80_block64_confidence ;;
    1) arm=threshold_0.80_block256_confidence ;;
    2) arm=threshold_0.90_block64_confidence ;;
    3) arm=threshold_0.90_block256_confidence ;;
    4) arm=threshold_0.95_block64_confidence ;;
    5) arm=threshold_0.95_block256_confidence ;;
