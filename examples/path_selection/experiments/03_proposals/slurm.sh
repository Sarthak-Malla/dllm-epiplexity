...
# Submit manually: sbatch /home/sarthak.malla/dllm-selection-ensemble/examples/path_selection/experiments/03_proposals/slurm.sh
...
# Continue every distinct candidate in the two fixed-four pools.
run_training_free diagnose --experiment proposals
